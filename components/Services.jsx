    ...
    <section className="py-20 -mt-32 ">
      <div className="container mx-auto px-8">
        ...
        <div className="flex flex-wrap flex-col items-center mt-32">
          ...
          <div className="w-full grid grid-cols-1 text-center lg:grid-cols-2 md:text-left px-2 mt-16 mr-auto ml-auto">
            <div className=" h-full flex flex-col justify-center">
            <h4 className=" text-2xl md:text-h3 mb-2 font-semibold leading-relaxed ">Reach a global audience of buyers who appreciate handmade goods.</h4>
                <p className="text-lg font-semibold leading-relaxed mt-4 mb-4 text-gray-700 mb-6">
            ...
            <div >
              <img
                ...
                className="w-full align-middle shadow-4xl md:h-[300px] lg:h-full object-cover"
              />
