...
const Crafts = () => {
  return (
    /* p-[200px] is necessary to avoid glitchiness*/
    <div className="h-full w-full bg-black- flex justify-center py-[200px]">
            ...
            <div className="card__content">
              <div className="h-[50%]">
                ...
                <div className="flex flex-wrap w-full justify-between">
                  <button className="card__button w-[100%] sm:w-[40%]">See More</button>
              ...
              <div className="flex  items-center justify-between h-[50%] ">
                <div className="flex">
                  ...
                  <div className="hidden md:block">
                    ...
                    <p className="text-md font-extralight ml-1"> @userName</p>
                  </div>
                </div>
